...
- DPS310 Temperature and Pressure Sensor (late 2025/early 2026 models may not have the DPS310 populated due to it
  being discontinued; mid 2026 and later models use a DPS368 with the same features).
- SCD-40 CO2 Sensor.
- RGB Pixel.
- Piezo Buzzer.
