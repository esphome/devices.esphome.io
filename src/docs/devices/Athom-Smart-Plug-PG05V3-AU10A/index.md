...
![Athom Smart Plug AU V3](athom-plug-au-v3.webp "Athom Smart Plug AU V3 - PG05V3-AU10A")

Maker: [Athom](https://www.athom.tech/)

Product page: [ESP32-C3 AU Plug Made for ESPHome](https://www.athom.tech/blank-1/esp32-c3-au-plug-for-esphome)

## Description

The Athom Smart Plug AU V3 is a 10 A AU smart plug pre-installed with ESPHome for local control through Home
...
- 10 A maximum load with over-current shutoff
